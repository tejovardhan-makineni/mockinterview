...
| Earlier policy release | Versioned adult/terms/privacy acknowledgments, hosted-route enforcement, pre-upload/pre-voice notices, Gemini BYOK billing declarations, retired camera-analysis ingestion, resume deletion and revised notices are deployed. That release used production API `mockinterview-api-00041-cic` at 100% traffic from build source `58280bab2d55c1047c7e388ba72c1ddefe51befe`. Web source `061b56bc6b26ab33baf092a9679f123a60b92764` has the same API tree; Firebase version `b8a9451c163cb83d` was promoted at `2026-09-10T09:15:21.533Z` and verified at `2026-09-10T09:17:02Z`. All six required checks and CodeQL passed. Exact evidence and limits are in the [policy release validation](RELEASE-VALIDATION-2026-09-10.md). |
| Current feedback release | Required product check-ins, optional comments/transcript permission, account export/deletion and private aggregate/suggestion views are deployed. API `mockinterview-api-00044-sib` serves 100% traffic, paired with Firebase `4fde692b40426e74`; both builds use source `13a7619`. Current terms/privacy version is `2026-09-10.1`. Verification at `2026-09-10T16:20:56Z` preserved existing data and legacy exemptions. The [feedback release record](FEEDBACK-RELEASE-2026-09-10.md) separates implementation evidence from the unresolved lawful-basis and research decisions below. |
