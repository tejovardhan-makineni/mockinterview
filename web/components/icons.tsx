...
// Stacked layers — Practice Packs (a company/goal interview loop).
export const IconPacks = (p: IconProps) => (
  <Svg {...p}><path d="M12 2l9 5-9 5-9-5 9-5z" /><path d="M3 12l9 5 9-5" /><path d="M3 17l9 5 9-5" /></Svg>
);
